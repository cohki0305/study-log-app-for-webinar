...
-- CreateIndex
CREATE INDEX "StudyLog_userId_createdAt_idx" ON "StudyLog"("userId", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "PomodoroSession_studyLogId_idx" ON "PomodoroSession"("studyLogId");
...
-- AddForeignKey
ALTER TABLE "PomodoroSession" ADD CONSTRAINT "PomodoroSession_studyLogId_fkey" FOREIGN KEY ("studyLogId") REFERENCES "StudyLog"("id") ON DELETE CASCADE ON UPDATE CASCADE;
